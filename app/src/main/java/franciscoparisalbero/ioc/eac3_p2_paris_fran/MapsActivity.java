package franciscoparisalbero.ioc.eac3_p2_paris_fran;
...
public class MapsActivity extends AppCompatActivity implements
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng home = new LatLng(41.420787, 2.197353);
...
//                .image(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED))
//                .position(home, 100);

//        mMap.addGroundOverlay(homeOverlay);
        mMap.addMarker(new MarkerOptions()
                .position(home)
                .title("La meva localització és:")
                .snippet(String.valueOf(home)))
                .showInfoWindow();

        UiSettings sets = mMap.getUiSettings();
